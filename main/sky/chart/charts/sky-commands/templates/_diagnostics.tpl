{{- define "sky-commands.diagnosticsAppEnv" -}}
...
{{- define "sky-commands.diagnosticsAppVolumeMount" -}}
{{- if .Values.diagnostics.enabled }}
...
{{- define "sky-commands.diagnosticsContainer" -}}
{{- if .Values.diagnostics.enabled }}
- name: dotnet-monitor
...
{{- define "sky-commands.diagnosticsVolumes" -}}
{{- if .Values.diagnostics.enabled }}
- name: dotnet-diagnostics
  emptyDir:
